...
This is a planning directory, not a codebase. There is no build system, no tests, and it is not a git repository. It contains a 3-month AI/deep-learning study plan for the NVIDIA DGX Spark:
